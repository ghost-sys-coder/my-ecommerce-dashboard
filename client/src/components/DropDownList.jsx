...
function DropDownList({selected, setSelected}) {
  ...
  return (
      <>
          {loading ? (<div className="flex gap-1 items-center">
              <Loader2 size={25} className="text-light-1 font-poppins" />
              <span className="text-sm font-mono text-light-1">Loading...</span>
          </div>): (
              <div className="w-72">
